...
let gCode;
let completeLinks;
let completeLinksIndex=0; 
let completeLinksLength;
...
browserOpenPromise
  ...
  .then(function (allLinks) {
    // [ link , link , link , link]
     completeLinks = allLinks.map(function (link) {
      return "https://www.hackerrank.com" + link;
    });
    // console.log(completeLinks);
    completeLinksLength= Object.size(completeLinks);
    let oneQuesSolvePromise = solveQuestion(completeLinks[completeLinksIndex]);
  ...
  return new Promise(function (resolve, reject) {
    ...
    gotoPromise
      ...
      .then(function (){
              ...
              let waitForNext= tab.waitForSelector(
      ...
      .then(function(){
              completeLinksIndex+=1;
              
              if(completeLinksIndex<completeLinksLength){
                let aqsp = solveQuestion(completeLinks[completeLinksIndex]);
...
//     let oneQuesSolvePromise = solveQuestion(completeLinks[1]);
//     return oneQuesSolvePromise;
//   })
//   .then(function() {
//     console.log("One Ques Solved Succesfully !!!!");
...
//     })
//     .then(function (){
//       let waitForNext= tab.waitForSelector(".ui-btn ui-btn-normal ui-btn-secondary submission-wrapper-next-entity-btn ui-btn-link ui-btn-styled");
//       return waitForNext;
//     })
//     .then(function(){
//       completeLinksIndex+=1;
